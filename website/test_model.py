...
def calculate_accuracy(primary_dir, model_dir, test_file_name):
    ...
    with torch.no_grad():
        for test_data in test_loader:
            ...
            # test_outputs = Activations(sigmoid=True)(test_outputs)
...
def plot_segmentation_slices(test_patient, test_outputs):
    for i in range(0, 50):
        ...
        #TODO: Change the directory with relative path

        plt.savefig(os.path.join("G:/OrganSegmentationApplication/data/model_results", f"output_{i}.png"))
        plt.show()
        plt.close()
...
#     test_file_name = "liver_13_6.nii.gz"
